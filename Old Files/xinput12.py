...
subprocess.Popen([program, "udpsrc", "port=4200", "!", "application/x-rtp,", "payload=96", "!", "rtpjitterbuffer", "!", "rtph264depay", "!", "avdec_h264", "!", "fpsdisplaysink", "sync=false", "text-overlay=false"], shell=True)
