...
int potPin = 0; //we will read the potentiometer value on analog pin 0
int a = 0;
double incomingByte;
//**********************************************
...
#define PERM_ERROR 2 //the max permissible error in degrees. In my potentiometer, a turn only about 3 degrees
...
void loop()
{
  ...
  showNewNumber();
  customServo.GoToAngle(dataNumber, turnSpeed);
}
...
void showNewNumber() {
  if (newData == true) {
    ...
    Serial.print("Analog In ... ");    // new for this version
