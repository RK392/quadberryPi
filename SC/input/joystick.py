...
class XINPUT_GAMEPAD(ctypes.Structure):
    _fields_ = [
        (INPUT_BUTTONS, ctypes.c_ushort),  # wButtons
        (INPUT_LEFT_TRIGGER, ctypes.c_ubyte),  # bLeftTrigger
        (INPUT_RIGHT_TRIGGER, ctypes.c_ubyte),  # bRightTrigger
        (INPUT_LEFT_THUMB_X, ctypes.c_short),  # sThumbLX
        (INPUT_LEFT_THUMB_Y, ctypes.c_short),  # sThumbLY
        (INPUT_RIGHT_THUMB_X, ctypes.c_short),  # sThumbRx
        (INPUT_RIGHT_THUMB_Y, ctypes.c_short),  # sThumbRy
    ]
